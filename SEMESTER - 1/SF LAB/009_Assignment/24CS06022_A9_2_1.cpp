...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "6. Display malicious data" << endl;
        cout << "7. Add malicious node" << endl;
        cout << "8. Exit" << endl;
        cout << "Enter choice: ";
        cin >> choice;
        ...
        else if (choice == 6)
        {
            ...
            if (malKey == "")
            {
                ...
                cout << "Enter key: ";
                cin >> key;
                Node *node = chordRing.getNode(malNodeId);
                if (node)
                {
                    cout << "Data for key '" << key << "': " << node->lookupData(key) << endl;
                }
                ...
                {
                    cout << "Node " << malNodeId << " does not exist." << endl;
                }
            ...
            else
            {
                ...
                if (node)
                {
                    cout << "Data for key '" << malKey << "': " << node->lookupData(malKey) << endl;
                }
                else
                {
                    cout << "Node " << malNodeId << " does not exist." << endl;
        ...
        else if (choice == 7)
        {
            ...
            {
                cout << "Malicious Node is already in network with id: " << malNodeId << endl;
            }
        }
        else if (choice == 8)
        {
